<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="WarehouseManagementServiceClient.Update" %>
                ...
                <table class="auto-style4">  
                     <tr>  
                        <td class="auto-style1">  
                            <br />
                            Enter Id For Which you want to Update data<br />
&nbsp;</td>  
                        <td class="auto-style1"> 
                            <br />
                            <br /> 
                    ...
                    <tr>  
                        ...
                        <td class="auto-style6">  
                            <asp:Button ID="btnSubmit" Visible="false" runat="server" Text="Update" OnClick="btnSubmit_Click" Height="25px" Width="100px" />  
                        </td>  
                    </tr>  
                    <tr>  
                        <td colspan="2">  
