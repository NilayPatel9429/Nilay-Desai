...
<tr>
	...
	<td>
		<h2><input type="text" id="srNo" name="srNo" value=<% out.print(srNo); %> /></h2>
	</td>
</tr>
	<tr>
	<td>
        ...
        <td>
        <h2><input type="text" name="warehouseCity" id="warehouseCity" required></h2>
        </td>
        </tr>
        <tr>
        <td>
		...
		<td>
        <h2><input type="text" name="warehouseName" id="warehouseName" required></h2>
        </td>
        </tr>
        <tr>
        <td>
        ...
        <td>
        <h2><input type="text" name="companyName" id="companyName" required></h2>
        </td>
        </tr>
        <tr>
        <td>
        ...
        <td>
        <h2><input type="text" name="itemName" id="itemName" required></h2>
        </td>
        </tr>
        <tr>
        <td>
        ...
        <td>
        <h2><input type="number" name="quantity" id="quantity" required></h2>
        </td>
        </tr>
        <tr>
        <td>
        ...
        <td>
        <h2><input type="text" name="location" id="location" required></h2>
        </td>
        </tr>
        <tr>
        <td>
