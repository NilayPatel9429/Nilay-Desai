...
<table id="customers">
	<%
		...
		for(int i=0;i<ware.length;i++)
		{
			...
			<td>
				<h3><% out.print(srNo); %></h3>  
			</td>
			<td>
				<h3><% out.print(warehouseCity); %></h3>  
			</td>
			<td>
				<h3><% out.print(warehouseName); %></h3>  
			</td>
			<td>
				<h3><% out.print(companyName); %></h3>  
			</td>
			<td>
				<h3><% out.print(itemName); %></h3>  
			</td>
			<td>
				<h3><% out.print(quantity); %></h3>  
			</td>
			<td>
				<h3><% out.print(location); %></h3>  
			</td>
